...
static struct error_map fuse_error_list[] = {
	...
	{ LTFS_CREPO_UNAVAILABLE,        "I1172E", EAGAIN},
	{ LTFS_CREPO_OUT_OF_SYNC,        "I1173E", EAGAIN},
	{ LTFS_NODE_STATUS_ERR,          "I1174E", EIO},
	{ LTFS_OUT_OF_SYNC,              "I1175E", EAGAIN},
	{ LTFS_CACHE_SYNC_FAILED,        "I1176E", EAGAIN },
	{ LTFS_DCACHE_SYNC_FAILED,       "I1177E", EAGAIN },
	{ LTFS_CREPOS_SYNC_FAILED,       "I1178E", EAGAIN },
	{ LTFS_NO_MULTINODE_CONFIG,      "I1179E", ENOENT },
	{ LTFS_MULTINODE_FILE_ERR,       "I1180E", EIO },
	...
	{ EDEV_HARDWARE_ERROR,           "D0401E", EIO},
...
int errormap_fuse_error(int val)
{
	...
	ltfsprintf("no error found (%d)", val);
	return -EIO;
}
